 ...
 * under the License.
 */
package com.ls.infrastructure.hooks.service;

import static com.ls.infrastructure.hooks.api.HookApiConstants.actionNameParamName;
import static com.ls.infrastructure.hooks.api.HookApiConstants.configParamName;
import static com.ls.infrastructure.hooks.api.HookApiConstants.contentTypeName;
import static com.ls.infrastructure.hooks.api.HookApiConstants.entityNameParamName;
import static com.ls.infrastructure.hooks.api.HookApiConstants.eventsParamName;
import static com.ls.infrastructure.hooks.api.HookApiConstants.nameParamName;
import static com.ls.infrastructure.hooks.api.HookApiConstants.payloadURLName;
import static com.ls.infrastructure.hooks.api.HookApiConstants.templateIdParamName;
import static com.ls.infrastructure.hooks.api.HookApiConstants.webTemplateName;
...
import com.ls.infrastructure.hooks.domain.HookConfiguration;
import com.ls.infrastructure.hooks.domain.HookRepository;
import com.ls.infrastructure.hooks.domain.HookResource;
import com.ls.infrastructure.hooks.domain.HookTemplate;
import com.ls.infrastructure.hooks.domain.HookTemplateRepository;
import com.ls.infrastructure.hooks.domain.Schema;
import com.ls.infrastructure.hooks.exception.HookNotFoundException;
import com.ls.infrastructure.hooks.exception.HookTemplateNotFoundException;
import com.ls.infrastructure.hooks.processor.ProcessorHelper;
import com.ls.infrastructure.hooks.processor.WebHookService;
import com.ls.infrastructure.hooks.serialization.HookCommandFromApiJsonDeserializer;
import com.ls.infrastructure.security.service.PlatformSecurityContext;
import com.ls.template.domain.Template;
import com.ls.template.domain.TemplateRepository;
import com.ls.template.exception.TemplateNotFoundException;
