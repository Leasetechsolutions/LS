...
import com.ls.infrastructure.hooks.data.*;
...
public class HookReadPlatformServiceImpl implements HookReadPlatformService {
    ...
    @Override
    @Cacheable(value = "hooks", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('HK')")
