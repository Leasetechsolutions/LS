 ...
 * under the License.
 */
package com.ls.infrastructure.codes.service;
...
import com.ls.infrastructure.codes.domain.Code;
import com.ls.infrastructure.codes.domain.CodeRepository;
import com.ls.infrastructure.codes.exception.CodeNotFoundException;
import com.ls.infrastructure.codes.exception.SystemDefinedCodeCannotBeChangedException;
import com.ls.infrastructure.codes.serialization.CodeCommandFromApiJsonDeserializer;
...
public class CodeWritePlatformServiceJpaRepositoryImpl implements CodeWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "codes", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('cv')")
