 ...
 * under the License.
 */
package com.ls.infrastructure.security.filter;
...
import com.ls.infrastructure.cache.domain.CacheType;
import com.ls.infrastructure.cache.service.CacheWritePlatformService;
...
import com.ls.infrastructure.security.data.PlatformRequestLog;
import com.ls.infrastructure.security.exception.InvalidTenantIdentiferException;
import com.ls.infrastructure.security.service.BasicAuthTenantDetailsService;
...
public class TenantAwareBasicAuthenticationFilter extends BasicAuthenticationFilter {
    ...
    private final String tenantRequestHeader = "LS-Platform-TenantId";
    ...
    public void doFilter(final ServletRequest req, final ServletResponse res, final FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            response.addHeader("WWW-Authenticate", "Basic realm=\"" + "LS Platform API" + "\"");
