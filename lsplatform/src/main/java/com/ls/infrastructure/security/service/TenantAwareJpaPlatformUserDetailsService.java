 ...
 * under the License.
 */
package com.ls.infrastructure.security.service;

import com.ls.infrastructure.security.domain.PlatformUser;
import com.ls.infrastructure.security.domain.PlatformUserRepository;
...
public class TenantAwareJpaPlatformUserDetailsService implements PlatformUserDetailsService {
    ...
    @Override
    @Cacheable(value = "usersByUsername", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#username+'ubu')")
