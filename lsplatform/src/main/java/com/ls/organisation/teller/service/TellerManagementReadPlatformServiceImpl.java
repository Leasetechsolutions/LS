...
import com.ls.organisation.teller.data.CashierData;
import com.ls.organisation.teller.data.CashierTransactionData;
import com.ls.organisation.teller.data.CashierTransactionTypeTotalsData;
import com.ls.organisation.teller.data.CashierTransactionsWithSummaryData;
import com.ls.organisation.teller.data.TellerData;
import com.ls.organisation.teller.data.TellerJournalData;
import com.ls.organisation.teller.data.TellerTransactionData;
import com.ls.organisation.teller.domain.CashierTxnType;
import com.ls.organisation.teller.domain.TellerStatus;
...
public class TellerManagementReadPlatformServiceImpl implements TellerManagementReadPlatformService {
    ...
    @Cacheable(value = "tellers", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')")
