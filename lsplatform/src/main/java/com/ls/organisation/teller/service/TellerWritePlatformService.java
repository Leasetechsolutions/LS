 ...
 *
 * @author Markus Geiss
 * @see com.ls.organisation.teller.domain.TellerRepository
 * @since 2.0.0
 */
public interface TellerWritePlatformService {
     ...
     * @throws com.ls.infrastructure.core.exception.PlatformApiDataValidationException
     * @throws com.ls.infrastructure.core.exception.InvalidJsonException
     */
     ...
     * @return {@code CommandProcessingResult} if successful
     * @throws com.ls.organisation.teller.exception.TellerNotFoundException
     * @throws com.ls.infrastructure.core.exception.PlatformApiDataValidationException
     * @throws com.ls.infrastructure.core.exception.InvalidJsonException
     */
