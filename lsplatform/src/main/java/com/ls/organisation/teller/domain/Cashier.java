 ...
 * under the License.
 */
package com.ls.organisation.teller.domain;
...
public class Cashier extends AbstractPersistableCustom<Long> {
     ...
     * @see com.ls.organisation.office.domain.Office
     */
     ...
     * @see com.ls.organisation.staff.domain.Staff
     */
     ...
     * @see com.ls.organisation.teller.domain.Teller
     */
