...
import com.ls.organisation.office.data.OfficeTransactionData;
import com.ls.organisation.office.exception.OfficeNotFoundException;
...
public class OfficeReadPlatformServiceImpl implements OfficeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "offices", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')")
    ...
    @Override
    @Cacheable(value = "officesForDropdown", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'ofd')")
    ...
    @Override
    @Cacheable(value = "officesById", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#officeId)")
