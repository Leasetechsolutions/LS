...
import com.ls.batch.serialization.BatchRequestJsonHelper;
import com.ls.batch.service.BatchApiService;
 ...
 * {@link com.ls.batch.service.BatchApiService} and de-serializes the
 * incoming JSON string to a list of
 * {@link com.ls.batch.domain .BatchRequest} type. This list is
 * forwarded to BatchApiService which finally returns a list of
 * {@link com.ls.batch.domain.BatchResponse} type which is then
 * serialized into JSON response by this Resource class.
 * 
 * @author Rishabh Shukla
 * 
 * @see com.ls.batch.service.BatchApiService
