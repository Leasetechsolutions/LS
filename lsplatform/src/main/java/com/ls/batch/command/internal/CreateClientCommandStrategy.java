...
/**
 * Implements {@link com.ls.batch.command.CommandStrategy} to handle
 * creation of a new client. It passes the contents of the body from the
 * BatchRequest to
 * {@link com.ls.portfolio.client.api.ClientsApiResource} and gets
 * back the response. This class will also catch any errors raised by
 * {@link com.ls.portfolio.client.api.ClientsApiResource} and map
