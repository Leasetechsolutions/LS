 ...
 * under the License.
 */
package com.ls.portfolio.self.account.service;

import static com.ls.portfolio.self.account.api.SelfBeneficiariesTPTApiConstants.ACCOUNT_NUMBER_PARAM_NAME;
import static com.ls.portfolio.self.account.api.SelfBeneficiariesTPTApiConstants.ACCOUNT_TYPE_PARAM_NAME;
import static com.ls.portfolio.self.account.api.SelfBeneficiariesTPTApiConstants.NAME_PARAM_NAME;
import static com.ls.portfolio.self.account.api.SelfBeneficiariesTPTApiConstants.OFFICE_NAME_PARAM_NAME;
import static com.ls.portfolio.self.account.api.SelfBeneficiariesTPTApiConstants.TRANSFER_LIMIT_PARAM_NAME;
...
import com.ls.portfolio.self.account.data.SelfBeneficiariesTPTDataValidator;
import com.ls.portfolio.self.account.domain.SelfBeneficiariesTPT;
import com.ls.portfolio.self.account.domain.SelfBeneficiariesTPTRepository;
import com.ls.portfolio.self.account.exception.InvalidAccountInformationException;
import com.ls.portfolio.self.account.exception.InvalidBeneficiaryException;
