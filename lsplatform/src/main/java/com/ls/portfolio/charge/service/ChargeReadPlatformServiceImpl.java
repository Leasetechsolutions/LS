 ...
 * under the License.
 */
package com.ls.portfolio.charge.service;
...
import com.ls.portfolio.charge.domain.ChargeAppliesTo;
import com.ls.portfolio.charge.domain.ChargeTimeType;
import com.ls.portfolio.charge.exception.ChargeNotFoundException;
...
public class ChargeReadPlatformServiceImpl implements ChargeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "charges", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('ch')")
