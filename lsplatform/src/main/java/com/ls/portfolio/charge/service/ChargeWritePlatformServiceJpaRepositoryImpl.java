...
import com.ls.portfolio.charge.api.ChargesApiConstants;
import com.ls.portfolio.charge.domain.Charge;
import com.ls.portfolio.charge.domain.ChargeRepository;
import com.ls.portfolio.charge.exception.ChargeCannotBeDeletedException;
import com.ls.portfolio.charge.exception.ChargeCannotBeUpdatedException;
import com.ls.portfolio.charge.exception.ChargeNotFoundException;
import com.ls.portfolio.charge.serialization.ChargeDefinitionCommandFromApiJsonDeserializer;
...
public class ChargeWritePlatformServiceJpaRepositoryImpl implements ChargeWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "charges", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('ch')")
