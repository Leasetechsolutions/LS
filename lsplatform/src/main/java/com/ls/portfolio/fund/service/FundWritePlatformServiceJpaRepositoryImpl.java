 ...
 * under the License.
 */
package com.ls.portfolio.fund.service;
...
import com.ls.portfolio.fund.serialization.FundCommandFromApiJsonDeserializer;
...
public class FundWritePlatformServiceJpaRepositoryImpl implements FundWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "funds", key = "T(com.ls.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('fn')")
